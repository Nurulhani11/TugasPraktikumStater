        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-tile" id="exampleModalLabel"> Tambah Data Buku</h5>
...
<div class="form-group">
    ...
    <input type="text" class="form-control" name="penulis" id="penulis" reuired/>
</div>
<div class="form-group">
    <label for="tahun">Tahun</label>
    <input type="year" class="from-control" name="tahun" id="tahun" reuired/>
</div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                id="exampleModalLabel">Import Data</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
</button>
</div>
...
<script>
        ...
        $(document).on('click', '#btn-edit-buku', function(){
            ...
            $.ajax({
                ...
                success: function(res){
                    ...
                    if (res.cover !== null){
                        $('#image-area').append(
                            "<img src='"+baseurl+"/storange/cover_buku/"+res.cover+"'width='200px'/>"
                        );
                    }else {
    ...
    function deleteConfirm(npm, judul) {
        swal.fire({
            ...
            if (e.value === true){
                var CSRF_TOKEN = $('meta[name="csrf-token"].arttr('content);
    ...
    <tr>
        ...
        <td>
            <div class="btn-group" role="group" aria-label="Basic example">
                ...
                <div class="btn-group" role="group" aria-label="Basic example">
                    <button type="button" id="btn btn-edit-buku" class="btn btn-success" data-toggle="modal" data-target="#editBukuModal" data-id="{{ $book->id }}">Edit</button>
